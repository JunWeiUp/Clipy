...
<p align="center">
  <img src="res/menubar.png" width="300" alt="macOS 菜单栏" />
  &nbsp;&nbsp;
  <img src="res/search.png" width="420" alt="全局搜索" />
</p>

<p align="center"><sub>左：菜单栏下拉，包含历史、片段、设备、截图与通知同步。 &nbsp;&nbsp; 右：全局搜索（<kbd>⇧</kbd><kbd>⌘</kbd><kbd>F</kbd>），支持正则与类型 / 来源 App / 日期筛选。</sub></p>
