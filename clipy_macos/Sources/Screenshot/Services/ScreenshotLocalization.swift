...
enum ScreenshotLocalization {
    ...
    static let zhHans: [String: String] = [
        ...
        "The recording could not be saved.": "录屏文件未能保存。",
        "Cancel": "取消",
        "Done": "完成",
        "Save": "保存",
        "Save All": "全部保存",
        ...
        "Required for screenshots and recording": "截图 / 录屏必需",
        "Accessibility": "辅助功能",
        "Paste simulation and element snap": "粘贴模拟、元素吸附",
        "Input Monitoring": "输入监控",
        "Keystroke display and mouse click highlight": "录屏按键显示、鼠标点击高亮",
        "Microphone": "麦克风",
        "Record voice during screen recording": "录屏录制人声",
        "Camera": "摄像头",
        "Webcam overlay during recording": "录屏摄像头悬浮窗",
        "Permissions": "权限",
        "Request Permission": "请求权限",
        "Screenshot": "截图",
        "Recording": "录屏",
        "After Recording": "录制完成动作",
        "Frame Rate (FPS)": "帧率 (FPS)",
        "Hide Recording Timer HUD": "隐藏录制计时 HUD",
        ...
        "Show Floating Thumbnail After Capture": "完成后显示浮动缩略图",
        "Stack Thumbnails for Consecutive Captures": "连续截图堆叠缩略图",
        ...
        "Capture Mouse Cursor": "捕获鼠标光标",
        "Downscale Retina Screenshots to 1×": "缩小 Retina 截图到 1×",
        "Play Sound After Capture": "完成后播放提示音",
        "Save Format": "保存格式",
        "Quality": "质量",
        "Scroll Capture & Drawing Aids": "滚动截图与绘制辅助",
        "Max Height: %d px": "最大高度：%d 像素",
        "Auto Scroll Speed": "自动滚动速度",
        "Detect Frozen Headers": "冻结表头检测",
        "Show Alignment Guides": "显示对齐辅助线",
        "Remember Last Used Tool": "记住上次使用的工具",
        "Show Shortcuts in Tooltips": "工具提示中显示快捷键",
        "Pencil Pressure (Apple Pencil)": "画笔压感（Apple Pencil）",
        "Pencil Smoothing": "画笔平滑",
        "Smart Marker (Fit Text Line Height)": "智能荧光笔（贴合文字行高）",
        "Beautify & Image Effects (Defaults)": "美化与图像特效（默认值）",
        "Enable Beautify Wrap by Default": "默认启用美化包裹",
        "Beautify Mode": "美化模式",
        "Window (with Traffic Lights)": "窗口（含红绿灯）",
        "Margin": "边距",
    ]
